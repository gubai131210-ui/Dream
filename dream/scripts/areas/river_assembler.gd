...
func _spawn_props(ysort: Node2D) -> void:
	var samples := [
		{"path": "res://assets/sprites/props/crate_0.png", "pos": Vector2(240, 380), "title": "岸边木箱", "desc": "渔民用的湿木箱。", "scale": 0.55},
		{"path": "res://assets/sprites/props/barrel_1.png", "pos": Vector2(760, 560), "title": "浮桶", "desc": "系在东岸岸桩旁的空桶。", "scale": 0.5},
...
func _spawn_fishing_spots(ysort: Node2D) -> void:
	## Fish-E append-only: bank-side cast points (not InfoPanel-only).
	var spots := [
		{
			"spot_id": "west_bend",
			"pos": Vector2(300, 420),
