...
static func _all() -> Dictionary:
	return {
		...
		"c26_waterfall_cave": {
			...
			"door_tx1": 12,
			"floor": "stone",
			"modulate": Color(0.5, 0.58, 0.62, 1.0),
			"rug": null,
			"window": false,
			"clusters": [
				_cluster("shrine", 11, 6, [
					_m(P_CRATE0, 0, 0, "贡品箱", "洞中旧箱。", 0.7),
					_m(P_LAMP_TAVERN, 0, -2, "洞烛", "潮湿烛火。", PROP),
					_m(P_SACK0, 2, 2, "湿袋", "洞内麻袋。", 0.55),
				]),
			],
			"fx": [],
			"ambient": [],
			"lights": [
				{"tx": 11, "ty": 5, "oy": -8, "color": Color(0.85, 0.9, 1.0), "energy": 0.75, "scale": 2.2},
			],
			"actor": {},
		},
		"c27_forest_hide_a": {
			...
			"door_tx1": 10,
			"floor": "straw",
			"modulate": Color(0.55, 0.62, 0.48, 1.0),
			"rug": null,
			"window": false,
			"clusters": [
				_cluster("camp", 8, 6, [
					_m(P_HAY, 0, 0, "干草铺", "临时铺位。", 0.7),
					_m(P_CRATE0, 2, 1, "猎获箱", "猎物箱。", PROP),
					_m(P_LAMP_FARM, -1, -1, "营灯", "隐所灯。", PROP),
				]),
			],
			"fx": [],
			"ambient": [],
			"lights": [
				{"tx": 8, "ty": 5, "oy": -8, "color": Color(1.0, 0.8, 0.5), "energy": 0.7, "scale": 1.6},
			],
			"actor": {},
		},
		"c27_forest_hide_b": {
			...
			"door_tx1": 9,
			"floor": "straw",
			"modulate": Color(0.5, 0.58, 0.45, 1.0),
			"rug": null,
			"window": false,
			"clusters": [
				_cluster("forage", 7, 5, [
					_m(P_BASKET, 0, 0, "蘑菇篮", "采集篮。", 0.75),
					_m(P_SACK0, 2, 1, "药草袋", "干药草。", 0.65),
					_m(P_HERBS, -2, 0, "挂草", "晾挂药草。", 0.55),
				]),
			],
			"fx": [],
			"ambient": [],
			"lights": [
				{"tx": 7, "ty": 4, "oy": -6, "color": Color(0.9, 1.0, 0.7), "energy": 0.55, "scale": 1.5},
			],
			"actor": {},
		},
	}
