...
const PROP := 0.55
const IP := "res://assets/sprites/interior/props"
const OP := "res://assets/sprites/props"

const P_FIREPLACE := IP + "/fireplace_00.png"
const P_FORGE := IP + "/forge_00.png"
const P_ANVIL := IP + "/anvil_00.png"
const P_STOVE := IP + "/stove_00.png"
const P_SHELF := IP + "/shelf_00.png"
const P_COUNTER := IP + "/counter_00.png"
const P_BAR := IP + "/bar_00.png"
const P_TABLE_R := IP + "/table_round_00.png"
const P_STOOL := IP + "/stool_00.png"
const P_HAY := IP + "/hay_00.png"
const P_TROUGH := IP + "/trough_00.png"
const P_NEST := IP + "/nest_00.png"
const P_TOOL_RACK := IP + "/tool_rack_00.png"
const P_DRESSER := IP + "/dresser_00.png"
const P_MEDICINE := IP + "/medicine_00.png"
const P_LEDGER := IP + "/ledger_00.png"
const P_BASKET := IP + "/basket_00.png"
const P_NOTICE := IP + "/notice_00.png"
const P_MUG_SHELF := IP + "/mug_shelf_00.png"
const P_CAULDRON := IP + "/cauldron_00.png"
const P_ROOST := IP + "/roost_00.png"
const P_COIN := IP + "/coin_chest_00.png"
const P_HERBS := IP + "/herbs_00.png"
const P_BED_S := IP + "/bed_single_00.png"
const P_BED_D := IP + "/bed_double_00.png"
const P_ROCKING := IP + "/rocking_00.png"
const P_BENCH0 := OP + "/bench_0.png"
const P_BARREL := OP + "/barrel_1.png"
const P_BARREL_KEG := OP + "/barrel_0.png"
const P_CRATE0 := OP + "/crate_0.png"
const P_CRATE1 := OP + "/crate_1.png"
const P_SACK0 := OP + "/sack_0.png"
const P_SACK1 := OP + "/sack_1.png"
const P_LAMP0 := OP + "/lamp_0.png"
const P_LAMP1 := OP + "/lamp_1.png"
