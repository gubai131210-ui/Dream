...
const ITEMS := [
	{"id": "square", "group": "户外", "title": "广场 C58–C60 / K·L姿态 / 门脸", "hint": "点井/树/箱/灯/喂鸟；白天点灯切夜间，关灯回白天（或 N）；桩草；锁门；K工作；L睡眠看枕头；「互动」", "expect": "通过：多帧 FX；点灯夜间粘性；关灯回白天；L 睡眠枕头可见；K/L 无卡死", "path": SceneRouter.SQUARE_PATH},
