...
| District multi-frame | DIK keyword→C58 FX sheets + **lamp PointLight toggle** | `GOAL_G8_DISTRICT_FX_EVIDENCE.md`；`GOAL_G8_DISTRICT_LAMP_TOGGLE_EVIDENCE.md`；market/forest/lighthouse/station MCP |
