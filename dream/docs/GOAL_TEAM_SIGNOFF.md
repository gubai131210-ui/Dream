...
| District multi-frame | DIK keyword→C58 FX + lamp toggle/radial + **Env-H night on lamp hosts** | `GOAL_G8_DISTRICT_*`；`GOAL_G8_LAMP_RADIAL_LIGHT_EVIDENCE`；`GOAL_G8_ENV_NIGHT_LAMP_EVIDENCE` |
