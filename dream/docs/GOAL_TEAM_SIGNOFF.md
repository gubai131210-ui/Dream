...
| C59 Breakables | stake/weed sprites + `mcp_clear` | `GOAL_G8_C59_BREAKABLES_EVIDENCE.md`；weed 重绘 |
| C60 Gates | locked_door unlock soften + fallen log repaint | `mcp_unlock`；`GOAL_G8_C60_GATES_EVIDENCE.md` |
