...
| District multi-frame | DIK keyword→C58 FX sheets + **lamp PointLight toggle + radial texture** | `GOAL_G8_DISTRICT_FX_EVIDENCE.md`；`GOAL_G8_DISTRICT_LAMP_TOGGLE_EVIDENCE.md`；`GOAL_G8_LAMP_RADIAL_LIGHT_EVIDENCE.md` |
...
| C54 life poses | eat/sleep/read/laundry/idle_sit ×4 | `GOAL_G8_C54_LIFE_POSE_EVIDENCE.md`；StyleQA GREEN |
