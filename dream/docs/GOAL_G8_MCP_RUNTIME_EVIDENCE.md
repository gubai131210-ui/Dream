...
| C33 night market idle | `docs/evidence/g8_c33_night_market_idle.png` | Wave D 夜市巷室内 |
| C33 night market board | `docs/evidence/g8_c33_night_market_board.png` | 夜市牌=`night_market_board_00` |
| C32 market back idle | `docs/evidence/g8_c32_market_back_idle.png` | Wave D 市场后台 |
| C37 warehouse idle | `docs/evidence/g8_c37_warehouse_idle.png` | Wave D 仓库 |
| C38 workshop idle | `docs/evidence/g8_c38_workshop_idle.png` | Wave D 工坊 |
...
- Headless `g8_c58_fx_smoke` PASS (well_rope / crate_lid / leaf_fall / bird_peck ×4)
