...
- [`GOAL_G8_LAMP_RADIAL_LIGHT_EVIDENCE.md`](GOAL_G8_LAMP_RADIAL_LIGHT_EVIDENCE.md) — 户外路灯径向光贴图（广场+District 共用 WorldSpawnUtil）  
- [`GOAL_G8_ENV_NIGHT_LAMP_EVIDENCE.md`](GOAL_G8_ENV_NIGHT_LAMP_EVIDENCE.md) — Env-H 夜间 + 路灯开关 MCP（广场/灯塔/车站）  
...
- [`GOAL_G8_USER_QA_LOAD_SMOKE_EVIDENCE.md`](GOAL_G8_USER_QA_LOAD_SMOKE_EVIDENCE.md) — §7 21 场景加载+关键 冒烟 21/21（`g8_user_qa_interact_smoke_21.png`） 
...
- [`GOAL_COMPLETION_AUDIT.md`](GOAL_COMPLETION_AUDIT.md) — 目标终态审计（Agent PROVEN；§7 仍开）
