...
| §7 load smoke | `g8_user_qa_load_smoke.tscn` | **21/21 PASS** enriched kits（WIK/C59/C60、Stall、Fish、WaterfallAnim、DIK、Portal_*）；`g8_user_qa_interact_smoke_21.png` + `mcp_status` |
