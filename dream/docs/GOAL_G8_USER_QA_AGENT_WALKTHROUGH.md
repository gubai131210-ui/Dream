...
| §7 load smoke | `g8_user_qa_load_smoke.tscn` | **21/21 PASS** tightened kits（WIK/C59/C60、Stall、Fish、WaterfallAnim、`SecretPassageChain_*`+secret portal、DIK、`Portal_*`）；prefix/exact match only；`g8_user_qa_interact_smoke_21.png` |
