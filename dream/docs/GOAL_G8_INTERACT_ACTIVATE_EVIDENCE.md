...
```
G8_INTERACT_SMOKE: start
G8_INTERACT_SMOKE: live_count=8
G8_INTERACT_SMOKE: activated sit_bench
G8_INTERACT_SMOKE: activated well_water
G8_INTERACT_SMOKE: activated shake_tree
G8_INTERACT_SMOKE: activated notice_board
G8_INTERACT_SMOKE: activated crate_search
G8_INTERACT_SMOKE: activated lamp_toggle
